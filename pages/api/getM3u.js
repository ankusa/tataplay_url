    ...
    if (errs.length === 0) {
        ...
        if (userChanDetails.err === null) {
            ...
            if (chansList.length > 0) {
                ...
                m3uStr += 'group-title=\"CheapGeeky - ' + (chansList[i].group_title) + '\", tvg-logo=\"https://mediaready.videoready.tv/tatasky-epg/image/fetch/f_auto,fl_lossy,q_auto,h_250,w_250/' + (chansList[i].tvg_logo) + '\", ' + chansList[i].name + '\n';
